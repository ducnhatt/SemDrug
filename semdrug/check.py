...
PATHS = {
    ...
    "pharmaDB": {
        ...
        "test_set": "/kaggle/input/semdrug/data/pharmaDB/pharmaDB_test_set.json",
        "embeddings": "/kaggle/input/semdrug/embeddings/pharmaDB_embeddings.pkl",
    },
}
        ...
        try:
            ...
            if mode in ["semantic_mmr", "heuristic"]:
                if args.disable_semantic_scoring:
                    # Ablation: original structural K-Paths, no semantic reranking.
                    paths = find_Kpaths(
                        G,
                        d1,
                        d2,
            ...
            # ---------------------------------------------------------
            # Final string-level safety leakage check
            # ---------------------------------------------------------
